...
# python length_output.py --input_length 224 --kernel_size 7 --stride 2 --padding 1

import argparse

if __name__ == '__main__':

    parser = argparse.ArgumentParser(description='Calculate the output length of an image')
    parser.add_argument('--input_length', type=int, help='Input length of the image')
    ...
    output_length = (args.input_length - args.kernel_size + 2 * args.padding) / args.stride + 1
