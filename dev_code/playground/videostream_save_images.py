...
class VideoStreamTello(object):
    def __init__(self, unit_dp=30, window_name="Drone Camera"):
        ...
        # Setting some attributes which will be necessary for saving frames from the camera feed
    ...
    def image_save(self):
        while self.save:
            try:
                ...
                self.image_path = os.path.join(self.base_directory, self.directory_name, self.filename)
